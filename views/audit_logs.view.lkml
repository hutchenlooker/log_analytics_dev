...
view: all_logs__proto_payload__audit_log__service_data__policy_delta__binding_deltas {
  ...
  measure: permissions_over_sa {
    ...
    type: count
    filters:
    [audit_logs.resource__type: "service_account", audit_logs.proto_payload__audit_log__method_name: "google.iam.admin.%.SetIAMPolicy", action: "ADD"]
  }
  ...
  measure: permissions_to_impersonate_sa {
    ...
    type: count
    filters:
    [audit_logs.resource__type: "service_account", audit_logs.proto_payload__audit_log__method_name: "google.iam.admin.%.SetIAMPolicy", action: "ADD", role: "roles/iam.serviceAccountTokenCreator,
